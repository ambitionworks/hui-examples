...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-gray-800 text-gray-50">
        <x-hui-page size="xl" class="sm:px-8">
            <x-hui-row class="h-full min-h-screen divide-x divide-gray-600 relative">
                <x-hui-col class="flex-grow fixed top-0 bottom-0 w-64">
                ...
                <x-hui-col class="flex-grow ml-64 mr-80">
                    <x-hui-row class="sticky border-b border-gray-600 p-4">
                    ...
                    <x-hui-col class="divide-y divide-gray-600">
                        @for ($i = 0; $i < 20; $i++)
                        <x-tweet />
                        @endfor
                    </x-hui-row>
                </x-hui-col>
                <x-hui-col class="px-4 py-2 min-h-screen absolute right-0 top-0 bottom-0 w-80">
                    <x-hui-container class="fixed w-72 space-y-4">
                        ...
                        <x-hui-list class="bg-gray-700 rounded-xl">
                            ...
                            <x-hui-list.item class="py-2 px-3 hover:bg-gray-600 transition">
                                <x-hui-row class="space-x-2 text-sm">
                                    <x-hui-popover hover position="br" class="flex-grow" contentClass="w-64 pt-2">
                                        ...
                                        <x-hui-col class="space-y-2 bg-gray-900 rounded-lg text-sm shadow-lg p-3">
                                            <x-hui-row>
                                                ...
                                                <x-hui-col class="items-end" size=6><x-hui-button size="sm" class="rounded-full border-blue-500 hover:border-blue-500 text-blue-500">Follow</x-hui-button></x-hui-col>
                                            </x-hui-row>
                                            <div>
                                                <x-hui-text b>Another User</x-hui-text>
                                                <x-hui-text class="text-gray-300">@another</x-hui-text>
                                    ...
                                    <div>
                                        <x-hui-button size="sm" class="rounded-full border-blue-500 hover:border-blue-500 text-blue-500">Follow</x-hui-button>
                                    </div>
                                </x-hui-row>
                            </x-hui-list.item>
                            <x-hui-divider class="border-gray-600" space=0 />
